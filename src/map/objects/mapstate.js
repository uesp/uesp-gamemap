 ...
 */
 ...
 export default class MapState {
    constructor(coords) {
        ...
        this.zoomLevel = (coords != null) ? (coords.zoom != null) ? coords.zoom : (coords[0] != null && coords[0].zoom != null) ? coords[0].zoom : DEFAULT_MAP_CONFIG.zoomLevel : DEFAULT_MAP_CONFIG.zoomLevel;
        this.world = null;
        this.showGrid = false;
        this.cellResource = "";
		this.layerIndex = 0;
